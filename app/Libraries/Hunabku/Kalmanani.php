...
class Kalmanani{
    ...
    public function __construct(){
        ...
        try {
            ...
            exit(":( Hunabku. Need your configuration parameters [ ".$th->getMessage()." ]");
        }
    ...
    */
    public function Render(){
        ...
        try {   
            ...
            $data = array_merge($params , array( $this->config->name_object => $this));
    ...
    */
    ...
    public function Component(string $view, array $params , $xss = TRUE):array{
        $_organism = [];
        ...
        try {
            ...
            endforeach;
            $this->_module_path = is_null($this->_module_path) ? $this->config->main_path : $this->_module_path;
    ...
    */
    ...
    private function trigger_javascripts($path) {
        ...
        $resource .= !filter_var($path, FILTER_VALIDATE_URL) === FALSE ? 
                        ...
                        script_tag($path.'?ver='.$this->app->version ) ;
        return $resource . "\n";
    }
